...
const AboutUs: React.FC = () => {
  ...
  return (
    <div className="about-container">
      ...
      <div className="about-content">
        <div className="glass-cardAbout animate-fade-in">
  ...
  <div className="values-grid">
    {[
      ...
      <div 
        key={value.id}
        className={`value-card glass-cardAbout animate-slide-up ${activeValue === value.id ? 'active' : ''}`}
      ...
      >
        ...
        <div className="team-preview glass-cardAbout">
