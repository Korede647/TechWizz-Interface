...
// Font is imported in CSS (see userDashboard.css)
...
const destinationMix: DestinationMix[] = [
  ...
  { name: "Moscow", continent: "Europe", value: 900.0 },
  { name: "Houston", continent: "North America", value: 500.0 },
];
...
const UserDashboard: React.FC = () => {
  ...
  return (
    <>
      <div
        className={`user-dashboard${sidebarOpen ? "" : " sidebar-collapsed"}`}
      >
        {/* Sidebar */}
